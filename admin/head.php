...
if(empty($_SESSION['pass2'])){
    ...
    <title>Admin Cpanel V5.0 - TMQ</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title">Quản lý thẻ</li><!-- /.menu-title -->
                    <?php if($TMQ['admin'] == 9){ ?>
                    <li>
                        <a href="/admin/list-nha-mang.html"> <i class="menu-icon fa fa-list-ol"></i>Danh sách nhà mạng</a>
                    </li>
                    <?php } ?>
                    <li>
                        <a href="/admin/quan-ly-the.html"> <i class="menu-icon fa fa-credit-card"></i>Kho thẻ</a>
                    </li>
                     <?php if($TMQ['admin'] == 9){ ?>
                
                     <li class="menu-title">Quản lý dịch vụ</li><!-- /.menu-title -->
 <li>
                        <a href="/admin/nap-the.html"> <i class="menu-icon fa fa-money"></i>Nạp thẻ</a>
                    </li>
                   <li>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img width="25%" src="/logo.png" alt="Logo"></a>
                ...
                <div class="header-menu">
                    <div class="header-left">
                        ...
                        <div class="dropdown for-notification">
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                                <p class="red">Bạn Có 2 Thông Báo</p>
                                <a class="dropdown-item media" href="#">
                                    <i class="fa fa-check"></i>
                                    <p>Bạn Đang Sử Dụng Cpanel Admin V5.0</p>
                                </a>
                                <a class="dropdown-item media" href="#">
                                    <i class="fa fa-warning"></i>
                                    <p>Nếu Chỉnh Sửa Bản Quyền TMQ Sẽ Không Được Hỗ Trợ.</p>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="/admin/thong-tin.html"><i class="fa fa -cog"></i>Settings</a>
