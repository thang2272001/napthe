...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": kích hoạt để sắp xếp cột tăng dần",sSortDescending:":kích hoạt để sắp xếp cột giảm dần"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Tiếp theo",sPrevious:"Trước đó"},sEmptyTable:"không có dữ liệu trong bảng",sInfo:"Hiển thị _START_ đến _END_ của _TOTAL_ mục",sInfoEmpty:"Hiển thị 0 đến 0 của 0 mục",
sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ mục",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy kết quả"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
